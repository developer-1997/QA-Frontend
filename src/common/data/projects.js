...
const projects = [
  {
    ...
    files: [
      { name: "QAPRENEURLanding.Zip", size: "3.25 MB", link: "#" },
      { name: "QAPRENEURAdmin.Zip", size: "3.15 MB", link: "#" },
      { name: "QAPRENEURLogo.Zip", size: "2.02 MB", link: "#" },
