...
const CompanyDetail = props => {
  //meta title
  document.title = "Company Detail | Skote - React Admin & Dashboard Template"

  const dispatch = useDispatch()

  const { companyDetail } = useSelector(state => ({
  ...
  useEffect(() => {
    if (params && params.id) {
      ...
      dispatch(onGetCompanyDetail(1)) //remove this after full integration
    }
                ...
                <div>
                  ...
                  <div className="position-relative">
                    <div className="profile_pic">
                      <img
                        src={`http://54.166.60.45:8000${companyDetail.image}`}
                        height={150}
                        width={150}
                      />
                    </div>
