...
const Companies = props => {
    ...
    document.title = `${isEdit ? "Edit Company" : "Create New Company"
        } | QAPRENEUR`
    ...
    const validation = useFormik({
        ...
        onSubmit: values => {
            console.log(values)
            if (isEdit)
                dispatch(onUpdateStudent(values, companyDetail._id, props.router.navigate))
                                        ...
                                        <Col lg="6">
                                            <div className="mb-4">
                                                ...
                                                <Input
                                                    ...
                                                    invalid={
                                                        validation.touched.founded && validation.errors.founded
                                                            ? true
                                                            : false
                                                    }
                                                />
